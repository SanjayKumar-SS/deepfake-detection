...
# Define custom LSTM without 'time_major'
def custom_lstm(*args, **kwargs):
    kwargs.pop('time_major', None)  # Ignore 'time_major' if it exists
    return LSTM(*args, **kwargs)



model = tf.keras.models.load_model('models/deepfake_detection_model.h5', custom_objects={'LSTM': custom_lstm})
# model = tf.keras.models.load_model('models/lstm_deepfake_image.h5')
# model = tf.keras.models.load_model('models/Meso4_model.h5')
# model = tf.keras.models.load_model('models/xception_deepfake_image.h5')
